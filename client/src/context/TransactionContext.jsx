...
const TranscationProvider = ({ children }) => {
    ...
    const sendTransaction = async () => {
        try {
            ...
            setIsLoading(false);
            console.log(`Successfully - ${transactionHash.hash}`);
    ...
    return (
        <TranscationContext.Provider value={{ connectWallet, currentAccount, formData, sendTransaction, handleChange }}>
            {children}
...
export default TranscationProvider